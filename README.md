...
The project is implemented with objective c.
...
If you are programing with Objective C language, we recommend you to use the modern Objective C interface and read `Usage Guide for QingStor Objective C style interface`.
And if you are programing with Objective C language, you should chose the Objective C style interface and read `Usage Guide for QingStor  style interface`.
